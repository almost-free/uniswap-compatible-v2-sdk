...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB, factoryAddress) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token, factoryAddress != null ? factoryAddress : FACTORY_ADDRESS), 18, 'UNI-V2', 'Uniswap V2');
