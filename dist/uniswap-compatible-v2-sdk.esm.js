...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB, factoryAddress, initCodeHash) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token, factoryAddress != null ? factoryAddress : FACTORY_ADDRESS, initCodeHash != null ? initCodeHash : INIT_CODE_HASH), 18, 'UNI-V2', 'Uniswap V2');
...
//# sourceMappingURL=uniswap-compatible-v2-sdk.esm.js.map
